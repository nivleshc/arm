 ...
 Install-WebApplicationProxy -FederationServiceName fs.nivlab.thecloudguy.info -FederationServiceTrustCredential $AdfsSvcCreds -CertificateThumbprint $cert.thumbprint
